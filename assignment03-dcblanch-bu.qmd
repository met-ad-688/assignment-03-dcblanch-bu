...
```{python}
# Group by ONET_NAME and compute median salary & job count
occupation_stats = (
...
# Convert to Pandas for plotting (optional: filter to top N if too many occupations)
bubble_df = occupation_stats.toPandas()
